...
// Init pagination first -- reads all rows, hides beyond page 1
  ...
  initPagination('ad-ntds-tbody',        [0, 1, 2, 3, 4],            25);
  initPagination('ad-sysvol-tbody',      [0, 1, 2, 3, 4, 5],         25);
  initPagination('ad-priv-groups-tbody', [0, 1],                     25);
  initPagination('ad-spn-tbody',         [0, 1, 2, 3, 4],            25);
  initPagination('ad-delegation-tbody',  [0, 1, 2, 3],               25);
  initPagination('ad-dcsync-tbody',      [0, 1, 2, 3],               25);
  initPagination('ad-priv-events-tbody', [0, 1, 2, 3],               25);
  initPagination('ad-object-changes-tbody', [0, 1, 2, 3, 4],         25);
  initPagination('ad-wmi-subs-tbody',    [0, 1, 2],                  25);
  initPagination('ad-suspicious-proc-tbody', [0, 1, 2, 3],           25);
  initPagination('mssql-services-tbody',      [0, 1, 2, 3, 4],       25);
  initPagination('mssql-config-tbody',        [0, 1, 2, 3],          25);
  initPagination('mssql-sysadmin-tbody',      [0, 1],                25);
  initPagination('mssql-linked-tbody',        [0, 1, 2, 3, 4],       25);
  initPagination('mssql-trustworthy-tbody',   [0, 1],                25);
  initPagination('mssql-agent-jobs-tbody',    [0, 1, 2, 3, 4, 5],    25);
  initPagination('mssql-logins-tbody',        [0, 1, 2, 3, 4],       25);
  initPagination('mssql-login-failures-tbody',[0, 1, 2],             25);
  initPagination('sp-accounts-tbody',         [0, 1, 2, 3],          25);
  initPagination('sp-suspicious-child-tbody', [0, 1, 2, 3, 4],       25);
  initPagination('sp-webshell-tbody',         [0, 1, 2, 3, 4, 5],    25);
  initPagination('sp-webconfig-tbody',        [0, 1, 2, 3],          25);
  initPagination('sp-iis-exploit-tbody',      [0, 1],                25);
  ...
  syncCount('ad-ntds-tbody',           'ad-ntds-count');
  syncCount('ad-sysvol-tbody',         'ad-sysvol-count');
  syncCount('ad-priv-groups-tbody',    'ad-priv-groups-count');
  syncCount('ad-spn-tbody',            'ad-spn-count');
  syncCount('ad-delegation-tbody',     'ad-delegation-count');
  syncCount('ad-dcsync-tbody',         'ad-dcsync-count');
  syncCount('ad-priv-events-tbody',    'ad-priv-events-count');
  syncCount('ad-object-changes-tbody', 'ad-object-changes-count');
  syncCount('ad-wmi-subs-tbody',       'ad-wmi-subs-count');
  syncCount('ad-suspicious-proc-tbody','ad-suspicious-proc-count');
  syncCount('mssql-services-tbody',       'mssql-services-count');
  syncCount('mssql-config-tbody',         'mssql-config-count');
  syncCount('mssql-sysadmin-tbody',       'mssql-sysadmin-count');
  syncCount('mssql-linked-tbody',         'mssql-linked-count');
  syncCount('mssql-trustworthy-tbody',    'mssql-trustworthy-count');
  syncCount('mssql-agent-jobs-tbody',     'mssql-agent-jobs-count');
  syncCount('mssql-logins-tbody',         'mssql-logins-count');
  syncCount('mssql-login-failures-tbody', 'mssql-login-failures-count');
  syncCount('sp-accounts-tbody',          'sp-accounts-count');
  syncCount('sp-suspicious-child-tbody',  'sp-suspicious-child-count');
  syncCount('sp-webshell-tbody',          'sp-webshell-count');
  syncCount('sp-webconfig-tbody',         'sp-webconfig-count');
  syncCount('sp-iis-exploit-tbody',       'sp-iis-exploit-count');
