...
Write-Host -Fore DarkCyan "[!] The Script took $TotalTime seconds to execute."
...
##Going back to the root directory in case we want to perform further actions on the output.
